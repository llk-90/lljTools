...
function initTime(){
    ...
    document.getElementById("time").innerHTML=data.getMonth()+"月"+day+"日"+"  "+data.getHours()+":"+data.getMinutes();
}
...
function onComplete(data) {
    ...
    document.getElementById("localtion").innerHTML=city+district+street
}
//解析定位错误信息
       ...
       /*      beforeSend:function(){
	   		...
	   		success: function(data) {
                   ...
                   // xval.remove();
	   				showToast("修改成功！！！");
	   				setTimeout(function(){
	   					window.location.href="eleFenceSet.html?openid="+openid+"&stuid="+stuId;
	   					},1000);
	   			  }
